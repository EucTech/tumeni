...
const PayTrack = () => {
  return (
    <div className="bg-[#fff] flex flex-col lg:flex-row   gap-8 py-10 px-5 md:px-10 lg:px-16 xl:px-32 overflow-hidden">
      ...
      >
        <div className=" mx-auto lg:mx-0 h-full flex flex-col lg:flex-row items-center justify-center gap-8 bg-[#4F35C8] rounded-[20px] p-8">
          <Image
            src={Images.pay}
            alt="Hero Image"
            width={1000}
          ...
          <div className="w-full lg:w-[50%] lg:text-start text-center flex flex-col gap-4">
            <h3
              className={`text-[#FFFFFF] text-[28px] font-sf font-[700] ${montserrat.className}`}
            >
              Pay & Track
            </h3>
            <p
              className={`text-[#FFFFFF] font-instrumentSans font-[400] text-[17px] ${montserrat.className}`}
            >
      ...
      >
        <div className="h-full mx-auto lg:mx-0 flex flex-col gap-6  bg-[#FFFCEA] rounded-[20px] p-8">
