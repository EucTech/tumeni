...
const HeroSection = () => {
  return (
    <div className=" relative w-full min-h-[34em] flex flex-col items-center text-center justify-center gap-10 bg-[#F6F5FE] py-10 px-5 sm:px-10 md:px-20 lg:px-40 overflow-hidden">
      <Fade
        direction="up"
        duration={1000}
        fraction={0.5}
      ...
      >
        <h1 className="w-full font-clashDisplay-semibold font-[600] text-[30px] sm:text-[40px] md:text-[50px] lg:text-[60px] text-[#000000] leading-[1.2]">
      ...
      <Fade
        ...
        delay={400}
        triggerOnce
        className="w-[90%] md:w-[80%] xl:w-[60%]"
      >
        <p className=" font-sf font-[400] text-[#343839] text-[16px] md:text-[18px] ">
      ...
      <Image
        ...
        height={500}
        quality={100}
        className="w-10 md:w-20 left-5 md:left-16 top-8 md:top-20 absolute"
      />
      ...
      <Image
        ...
        height={500}
        quality={100}
        className="w-10 md:w-20 right-5 md:right-12 top-8 md:top-20 absolute"
      />
      <Image
        src={Images.h1}
        alt="Hero Image"
